...
export class DigitaleZeitreisenC2 implements AfterViewInit, OnDestroy {
  ...
  onBack(): void {
    this.router.navigate(['/digitale-zeitreisen/C1']);
  }

  onNext(): void {
    this.router.navigate(['/digitale-zeitreisen/C3']);
  }
  ...
  async ngAfterViewInit() {
    const modulePath = '/assets/h5p/digitale-zeitreisen/C2';
    const content_id = `${this.studentAuthService.user().id}-digitale-zeitreisen-C2`;
