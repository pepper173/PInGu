...
export class DigitaleZeitreisenC3 implements AfterViewInit, OnDestroy {
  ...
  async ngAfterViewInit() {
    const modulePath = '/assets/h5p/digitale-zeitreisen/C3';
    const content_id = `${this.studentAuthService.user().id}-digitale-zeitreisen-C3`;
